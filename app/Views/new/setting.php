...
<div class="container confirm">
    <div class="row">
        <div class="col-lg-3 col-md-3 confirm-left">
            ...
            <img src="<?php echo base_url(); ?>/assets/img/upload/<?php echo $Picture['idUser'].'/'.$Picture['chibiFileName']; ?>" />
        </div>
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <form action="<?php echo base_url(); ?>/News/updateImage?id=<?php echo $Picture['idPictures']; ?>" method="post" style="margin-top: 10px;" enctype="multipart/form-data" id="form1">
                        <div class="row register-form">
                            ...
                            <div class="col-md-8">
                                <input class="form-control single-input" type="text" name="title" id="title" maxlength="45" value="<?php echo $Picture['Title'];?>">
                            </div>
                        </div>
                        <div class="row register-form margin-10px">
                            ...
                            <div class="col-md-9">
                                <input type="radio" name="mode" value="0" <?php if($Picture['idStatusPicture'] == '8') echo 'checked';?>> Công khai
                        ...
                        <div class="row register-form">
                            ...
                            <div class="col-md-9" >
                                ...
                                <input id="btn_confirm1" type="submit" class="btnFinish" value="Lưu lại" name="btnSubmit" style="margin-bottom: 10px; width: 140px;"/>
                            </div>
                        </div>
