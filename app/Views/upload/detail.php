        ...
        <div class=" col-lg-9 col-md-9 confirm-right">
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <form action="<?php echo base_url(); ?>/Upload/UploadFile/updatePictures?id=<?php echo $Picture['idPictures']; ?>" method="post" style="margin-top: 10px;">
                        ...
                        <div class="row register-form margin-10px">
                            ...
                            <div class="col-md-9">
                            <ul>
                                <li><input type="radio" id="cb1" name="ch1" value="1"/>
                                    <label for="cb1"><img src="<?php echo base_url(); ?>/assets/img/bg1.jpg" /></label>
                                </li>
                                <li><input type="radio" id="cb2" name="ch1" value="2"/>
                                    <label for="cb2"><img src="<?php echo base_url(); ?>/assets/img/bg1.jpg" /></label>
                                </li>
                                <li><input type="radio" id="cb3" name="ch1" value="3"/>
                                    <label for="cb3"><img src="<?php echo base_url(); ?>/assets/img/bg1.jpg" /></label>
                                </li>
                                <li><input type="radio" id="cb4" name="ch1" value="4"/>
                                    <label for="cb4"><img src="<?php echo base_url(); ?>/assets/img/bg1.jpg" /></label>
                                </li>
                                <li><input type="radio" id="cb5" name="ch1" value="5"/>
                                    <label for="cb5"><img src="<?php echo base_url(); ?>/assets/img/bg1.jpg" /></label>
                                </li>
                                <li><input type="radio" id="cb6" name="ch1" value="6"/>
                                    <label for="cb6"><img src="<?php echo base_url(); ?>/assets/img/bg1.jpg" /></label>
                                </li>
                                </ul>
                            </div>
                        </div>
