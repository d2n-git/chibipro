...
use CodeIgniter\Model;
    ...
    class PictureModel extends Model{
        ...
        public function getAllPicture($offset){
            ...
            $sql="SELECT pictures.idPictures, pictures.Name, pictures.Title, date_format(pictures.DateUp,'%d-%m-%Y') as DateUp, pictures.NumberLike, users.Name AS userName, users.Email FROM pictures INNER JOIN users ON pictures.idUser = users.idUser ORDER BY NumberLike DESC LIMIT " . LIMITPICTURE . " OFFSET " .$offset;
