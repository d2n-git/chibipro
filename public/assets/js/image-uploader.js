...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let createContainer = function () {
            ...
            let $container = $('<div>', {class: 'image-uploader dashed-area'});
            ...
            let $uploadedContainer = $('<div>', {class: 'uploaded'}).appendTo($container),
                ...
                $i = $('<i>', {class: 'ti-plus'}).appendTo($textContainer),
        ...
        let createImg = function (src, id, preloaded) {
            ...
            let $container = $('<div>', {class: 'uploaded-image'}),
                ...
                $i = $('<i>', {class: 'ti-trash'}).appendTo($button);
            ...
            $button.on("click", function (e) {
                ...
                if (!$parent.children().length) {
                    ...
                    $parent.parent().addClass('dashed-area');
        ...
        let setPreview = function ($container, files) {
            ...
            $container.addClass('has-files');
            $container.removeClass('dashed-area');
