    ...
    <input accept="image/*" id="file" type="file" class="custom-file-input" name="fileToUpload" onclick="delete()" required>
     <div style="height:25px;color:red"> <label for="file" class="error" style="" > </label></div>
      ...
      <div class="form-group">
          <label for="email" class="pull-left" style="line-height:2">Your Email: </label><input id="mail" style="width:220px;  " class="form-control" id="email" type="email" name="email" value="<?php session_start(); $_SESSION["email"] = (isset($_GET['email']) ? $_GET['email'] : null);  echo $_SESSION['email']; ?>" required>
      </div>
